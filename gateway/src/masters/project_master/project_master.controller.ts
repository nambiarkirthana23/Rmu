...
import {GatewayProjectService } from "./project_master.service";
import { ProjectDto } from "./project_master.dto";

@ApiTags('Project')
@Controller('project')
export class GatewayProjectController{
    constructor(
        private readonly projectService:GatewayProjectService
    ){}
